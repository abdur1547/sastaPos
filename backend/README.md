...
This app was created with [Bootify.io](https://bootify.io/app/8HAOTNQ05B7W) - tips on working with the code [can be found here](https://bootify.io/next-steps/).
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=com.sastapos/sasta-pos
```
